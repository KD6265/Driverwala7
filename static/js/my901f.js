...
$(document).on('click','#final_book',function(){
	...
	$.ajax({
	        ...
	        data: {"ride_type":ride_type,"ride_for":ride_for,"pickuploadtion":pickuploadtion,"drop_location":drop_location,"vehicle_type":vehicle_type,"vehicle_sub_type":vehicle_sub_type,"month":month,"date":date,"time":time,"duration_book":duration_book,"paymentmode":paymentmode,"cityid":cityid,"amount":amount,"duration":duration,"discount_amount":discount_amount,"promo_amount":promo_amount,"payble_amount":payble_amount,"ap_code_final":ap_code_final},
	        beforeSend: function () {
